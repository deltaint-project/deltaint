...
control egress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
	...
	action delta_calc4() {
		...
		if ((meta.dint_metadata.prev_timedelta4 >= standard_metadata.deq_timedelta) && ((meta.dint_metadata.prev_timedelta4 - standard_metadata.deq_timedelta) <= 10) || \
				(meta.dint_metadata.prev_timedelta4 < standard_metadata.deq_timedelta) && ((standard_metadata.deq_timedelta - meta.dint_metadata.prev_timedelta4) <= 10)) {
			hdr.intbitmap.timedelta_bit = 0;
	...
	action update_register4() {
		dint_register4.write(meta.dint_metadata.index4, \
				((bit<128>)(hdr.ipv4.srcAddr)<<96) | ((bit<128>)(hdr.ipv4.dstAddr)<<64) | \
				((bit<128>)(hdr.udp.srcPort)<<48) | ((bit<128>)(hdr.udp.dstPort)<<32) | \
				((bit<128>)(hdr.ipv4.protocol)<<24) | ((bit<128>)(meta.dint_metadata.output_deviceno)<<16) | \
				((bit<128>)(meta.dint_metadata.output_iport)<<8) | (bit<128>)(meta.dint_metadata.output_eport));
